...
class MasjidSeeder extends Seeder
{
    ...
    public function run()
    {
        \App\Models\Masjid::create([
            ...
            'gambar'        => 'https://api.bageurenterprise.com/img/listrikmasjid/20210115113943.jpg',
            'status'        => 'lunas',
            'tampil'        => 'ya',
        ...
        \App\Models\Masjid::create([
            ...
            'gambar'        => 'https://api.bageurenterprise.com/img/listrikmasjid/20210115113816.jpg',
            'status'        => 'lunas',
            'tampil'        => 'ya',
            'nama_pengurus' => 'Ahmad Yani',
            'no_pengurus'   => '087839994311'
        ...
        \App\Models\Masjid::create([
            ...
            'gambar'        => 'https://api.bageurenterprise.com/img/listrikmasjid/20210115111504.jpg',
            'status'        => 'lunas',
            'tampil'        => 'ya',
            'nama_pengurus' => 'Ahmad Yani',
            'no_pengurus'   => '087839994311'
        ...
        \App\Models\Masjid::create([
            ...
            'gambar'        => 'https://api.bageurenterprise.com/img/listrikmasjid/20210115111635.jpg',
            'status'        => 'belum_lunas',
            'tampil'        => 'ya',
            'nama_pengurus' => 'Ahmad Yani',
            'no_pengurus'   => '087839994311'
        ...
        \App\Models\Masjid::create([
            ...
            'gambar'        => 'https://api.bageurenterprise.com/img/listrikmasjid/20200716133629.jpeg',
            'status'        => 'belum_lunas',
            'tampil'        => 'ya',
            'nama_pengurus' => 'Ahmad Yani',
            'no_pengurus'   => '087839994311'
