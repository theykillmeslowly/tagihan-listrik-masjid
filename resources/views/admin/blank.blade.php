...
<head>
    ...
    <title>Sedekah Listrik Masjid - Administrator</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/index">
                ...
                <div class="sidebar-brand-text mx-3"><sup>Sedekah Listrik Masjid</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/masjid">Daftar Masjid</a>
                        <a class="collapse-item" href="/admin/pendaftaran">Pendaftaran Masjid</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/bantuan">
                  <i class="fas fa-fw fa-info"></i>
                  <span>Kelola Bantuan</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/admin/user">
                  <i class="fas fa-fw fa-user"></i>
                  <span>Kelola Administrator</span></a>
            </li>
            <!-- Nav Item - Tables -->
            <li class="nav-item">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Sedekah Listrik Masjid {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
